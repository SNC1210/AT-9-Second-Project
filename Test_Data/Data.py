...
class Data:
    ...
    Pim_UserName="aadi1210"+str(random.randrange(1,25))
    ...
    PIM_CD_Street1=str(random.randrange(1,100))+" Telecome nagar"
    PIM_CD_Street2=str(random.randrange(1,12))+"gachibowli near biodiversity park"
    PIM_CD_City="Hyderabad"
    PIM_CD_State="Telegana"
    ...
    PIM_EC_Name=random.choice(["Kshitij Kumar Sahu","Srilata","Aditi"])
    PIM_EC_Relationship=random.choice(["Collegue","Collegue","Collegue"])
    PIM_EC_Home_Tele= "98"
    ...
    PIM_Dep_DOB="1998-07-22"

    PIM_Immig_Document="Passport"
    PIM_Immig_Num="7897894564564589787"
    PIM_Immg_issueDate="2004-12-05"
    ...
    #PIM_Job_Details
    PIM_Job_JoiningDate="2021-12-16"
    ...
    PIM_Job_Contratc_StartDate="2021-12-16"
    PIM_Job_Contract_EndDate="2022-06-16"

    #PIM_Job_Termination_Details
    PIM_Termination_Reason="Resigned"
    PIM_Termination_Date="2023-05-31"
